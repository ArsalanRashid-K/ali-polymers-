      ...
      <section className="page-hero weave">
        <div className="wrap">
          <div className="breadcrumb">
            Home <span className="red">/</span> Contact
          </div>
          <h1 className="display">Let&apos;s Talk</h1>
          <p>
            Wholesale, distribution, or export enquiries — we usually respond
        ...
        <div className="contact-card">
          ...
          <div className="contact-row">
            ...
            <div>
              ...
              <div className="v">
                <a href="tel:+919400980951">+91 94009 80951</a>
              </div>
            </div>
          </div>
          <div className="contact-row">
